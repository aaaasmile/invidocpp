 ...
 */
//  ISS change: use ttf font in function DT_DrawText. Don't need bitmap font image.
...
{
    GFX_UTIL::DrawString(surface, string, x, y, GFX_UTIL_COLOR::White, g_pConsFontText);
    return;
}
