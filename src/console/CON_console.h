...
extern "C" {
	...
	typedef struct console_information_td {
		...
		int FontHeight;
		int FontWidth;
//! ISS: add proxy object to use callback on class member function
        void*          pProxy;
        //! rectangle for back image source
        SDL_Rect       Back_rctSrc;
        //! panel for trasparancy
        SDL_Surface*   pSurf_Bar;
	}
	ConsoleInformation;
